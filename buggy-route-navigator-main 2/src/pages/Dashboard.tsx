...
const Dashboard = () => {
  ...
  const transformLocationToBuggy = (location: BuggyLocation): DashboardBuggy => {
    ...
    return {
      ...
      batteryLevel: Math.floor(Math.random() * 100), // This would come from the API in a real implementation
            ...
            <div>
              ...
              <Tabs defaultValue="all">
                ...
                <TabsContent value="available" className="mt-0">
                  {loading ? (
                  ...
                  ) : buggies.filter(buggy => buggy.status === "available").length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {buggies
                    ...
                    <div className="text-center py-8">
                      <p className="text-muted-foreground">No available buggies found</p>
                    </div>
                  )}
                </TabsContent>
                ...
                <TabsContent value="busy" className="mt-0">
                  {loading ? (
                  ...
                  ) : buggies.filter(buggy => buggy.status === "busy").length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {buggies
                    ...
                    <div className="text-center py-8">
                      <p className="text-muted-foreground">No busy buggies found</p>
                    </div>
                  )}
                </TabsContent>
              </Tabs>
