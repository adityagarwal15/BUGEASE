    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0f1a] via-[#1a1a2e] to-[#1a1a2e] flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-white/60">Sign up to access campus transportation</p>
        </div>
        ...
        <Card className="glass-panel border border-white/10 backdrop-blur-md bg-[#1a1a2e]/70 shadow-xl">
          <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input 
                      ...
                      className={`bg-white/5 border border-white/10 text-white ${errors.firstName ? "border-red-500" : ""}`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input 
                      ...
                      className={`bg-white/5 border border-white/10 text-white ${errors.lastName ? "border-red-500" : ""}`}
              ...
              <div className="space-y-2">
                <label htmlFor="userType" className="text-sm font-medium text-white">
                  User Type
                </label>
                <div className="p-3 rounded-md bg-white/5 border border-white/10 text-sm">
                  <span className="text-white/80">Student</span>
                  <p className="text-xs text-white/60 mt-1">All accounts created are student accounts. Driver accounts are created by admins only.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                <Checkbox 
                  ...
                  className="border-white/30 data-[state=checked]:bg-[#7f5af0] data-[state=checked]:border-[#7f5af0]"
                  disabled={isLoading}
                />
                <label htmlFor="terms" className={`text-sm ${errors.termsAccepted ? "text-red-500" : "text-white/60"}`}>
                  I agree to the{" "}
                  <Link to="/terms" className="text-[#00d1ff] hover:underline">
                    Terms of Service
                  </Link>
                  {" "}and{" "}
                  <Link to="/privacy" className="text-[#00d1ff] hover:underline">
                    Privacy Policy
                  </Link>
                </label>
              </div>
