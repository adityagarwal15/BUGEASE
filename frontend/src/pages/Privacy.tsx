      ...
      <div className="container mx-auto px-4 py-16 -mt-12">
        <div className="max-w-4xl mx-auto bg-card rounded-lg shadow-sm p-6 md:p-8">
          <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none">
            <p>
              This Privacy Policy describes how CampusBuggy ("we," "us," or
              "our") collects, uses, and discloses your personal information
              when you use our campus transportation service, mobile
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                number, student ID, and profile picture.
              </li>
              <li>
                <strong>Location Information:</strong> GPS location data when
                you use our app to book rides or track buggies.
              </li>
              <li>
                <strong>Transaction Information:</strong> Records of rides,
                pickup and drop-off locations, timestamps, and payment
                information.
              </li>
              <li>
              ...
              <li>
                ...
                with our customer service team or feedback provided through the
                app.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Drivers:</strong> Limited information necessary to
                facilitate your ride.
              </li>
              <li>
              ...
              <li>
                <strong>University Administration:</strong> Information required
                for the operation and supervision of campus transportation
                services.
              </li>
              <li>
            ...
            <p>
              ...
              will be effective immediately upon posting. We encourage you to
            ...
            <p className="mt-2">
              <strong>Email:</strong> privacy@campusbuggy.com
              <br />
