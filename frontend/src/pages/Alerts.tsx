...
const mockAlerts = [
  {
    ...
    message:
      "Buggy #B-102 will arrive at Science Building in approximately 3 minutes",
    type: "info",
  ...
  },
  {
    ...
    title: "Ride canceled",
    message:
      "Your scheduled ride to Student Union has been canceled by the driver",
    type: "warning",
  ...
  },
  {
    ...
    title: "Campus alert",
    message:
      "Heavy traffic near Library complex due to ongoing event. Expect delays.",
    type: "danger",
                  ...
                  >
                    <CardContent className="p-4 flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3
                            className={`font-medium ${!alert.read ? "text-primary" : ""}`}
                          >
                            {alert.title}
                          </h3>
