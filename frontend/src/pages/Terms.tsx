      ...
      <div className="container mx-auto px-4 py-16 -mt-12">
        <div className="max-w-4xl mx-auto bg-card rounded-lg shadow-sm p-6 md:p-8">
          <div className="prose prose-sm md:prose-base dark:prose-invert max-w-none">
            <p>
              Welcome to CampusBuggy. These Terms of Service ("Terms") govern
              your use of our campus transportation service, mobile application,
              and website (collectively, the "Service"). Please read these Terms
            ...
            <p>
              To use our Service, you must be a current student, faculty member,
              staff, or authorized visitor of the university. You must be at
              least 18 years old or have the legal capacity to enter into these
              Terms under the laws of your jurisdiction.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                Not engage in any disruptive or inappropriate behavior during
                rides
              </li>
              <li>Not smoke, eat, or drink in the buggies</li>
              <li>Report any issues or safety concerns promptly</li>
              <li>
                Not damage or tamper with the buggies or related equipment
              </li>
            ...
            <p>
              You may book rides through our app or website, subject to buggy
              availability. We reserve the right to refuse service or cancel
              bookings at our discretion, including for violation of these
              Terms.
            </p>
            <p className="mt-2">
              You may cancel a booking at any time before the driver arrives.
              Repeated no-shows or late cancellations may result in temporary
              service restrictions.
            </p>

            <h2 className="text-xl font-bold mt-8 mb-4">5. Fees and Payment</h2>
            <p>
              Service fees, if applicable, will be clearly communicated before
              you confirm a booking. Payment methods and processing are subject
              to our Payment Policy. We reserve the right to modify our fees at
              any time with reasonable notice.
            </p>

            <h2 className="text-xl font-bold mt-8 mb-4">
              6. Location Services and Data Collection
            </h2>
            <p>
              Our Service uses location data to provide ride services. By using
              our Service, you consent to the collection and use of your
              location data as described in our Privacy Policy.
            </p>
            ...
            <p>
              ...
              are owned by CampusBuggy and are protected by international
              copyright, trademark, patent, trade secret, and other intellectual
              property laws. You may not reproduce, distribute, modify, create
              derivative works of, publicly display, publicly perform,
              republish, download, store, or transmit any materials from our
            ...
            <p>
              ...
              CampusBuggy be liable for any indirect, incidental, special,
            ...
            <p>
              You agree to defend, indemnify, and hold harmless CampusBuggy and
            ...
            <p>
              ...
              at our sole discretion. The modified terms will be effective
            ...
            <p className="mt-2">
              <strong>Email:</strong> legal@campusbuggy.com
              <br />
              <strong>Address:</strong> 123 University Drive, Campus Area, CA
              90210
              <br />
