      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="text-muted-foreground">
            Sign up to get started with campus transportation
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/50 border border-border text-sm">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    All accounts created are student accounts. Driver accounts
                    are created by admins only.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <label
                  htmlFor="terms"
                  className={`text-sm ${errors.termsAccepted ? "text-red-500" : "text-muted-foreground"}`}
                >
                  I agree to the{" "}
