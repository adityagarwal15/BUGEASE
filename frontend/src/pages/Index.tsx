        ...
        <div className="container relative mx-auto px-4 z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto">
              Your reliable ride around campus, connecting you to your classes,
              events, and friends with our electric buggy network.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
              ...
              <Link to="/tracking">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto bg-background/50 backdrop-blur-sm border-primary/20 hover:border-primary/50"
                >
                  Track Buggy
                </Button>
              </Link>
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 mr-2 text-primary" /> Zero
                Emissions
              </span>
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 mr-2 text-primary" /> Real-time
                Tracking
              </span>
              <span className="flex items-center">
              ...
              <span className="flex items-center">
                <CheckCircle className="h-4 w-4 mr-2 text-primary" /> Campus
                Coverage
              </span>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our electric buggy service offers more than just transportation -
              it's a complete campus mobility solution.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card hover:shadow-lg transition-all duration-300 rounded-xl p-8 hover:translate-y-[-5px]">
              ...
              <p className="text-muted-foreground text-center">
                Request a ride anytime, anywhere on campus. No need to wait for
                scheduled routes.
              </p>
            </div>
            ...
            <div className="bg-card hover:shadow-lg transition-all duration-300 rounded-xl p-8 hover:translate-y-[-5px]">
              ...
              <p className="text-muted-foreground text-center">
                Track your buggy's location in real-time and get notified when
                it arrives.
              </p>
            </div>
            ...
            <div className="bg-card hover:shadow-lg transition-all duration-300 rounded-xl p-8 hover:translate-y-[-5px]">
              ...
              <p className="text-muted-foreground text-center">
                Our buggies are electric, reducing your carbon footprint and
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              <div className="bg-background rounded-xl p-6 shadow-md h-full relative">
                ...
                <p className="text-muted-foreground text-center">
                  Hop on the buggy and enjoy a quick, comfortable ride to your
                  destination.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-border/30">
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "CampusBuggy has made getting to my early morning classes so
                  much easier. I no longer have to rush across campus!"
                </p>
                <div className="pt-4 border-t border-border/30 flex items-center">
                  <div className="bg-primary/5 h-10 w-10 rounded-full flex items-center justify-center text-primary font-bold">
                    SM
                  </div>
                  <div className="ml-3">
            ...
            <div className="bg-card rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-border/30">
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "I love that CampusBuggy is an eco-friendly way to get around
                  campus. It's great to have a sustainable transportation
                  option."
                </p>
                <div className="pt-4 border-t border-border/30 flex items-center">
                  <div className="bg-accent/5 h-10 w-10 rounded-full flex items-center justify-center text-accent font-bold">
                    JB
                  </div>
                  <div className="ml-3">
            ...
            <div className="bg-card rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-border/30">
              <div className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "CampusBuggy is always on time and the drivers are super
                  friendly. It's a reliable service that I can always count on."
                </p>
                <div className="pt-4 border-t border-border/30 flex items-center">
                  <div className="bg-secondary/5 h-10 w-10 rounded-full flex items-center justify-center text-secondary font-bold">
                    EL
                  </div>
                  <div className="ml-3">
