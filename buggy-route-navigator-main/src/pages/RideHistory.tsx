...
import { MapPin, Search, Calendar, ArrowUpDown, Download, FileText } from 'lucide-react';
...
const RideHistory = () => {
  ...
  const filteredRides = mockRideHistory.filter(ride => {
    ...
    if (searchQuery && !`${ride.pickupLocation.name} ${ride.dropoffLocation.name}`.toLowerCase().includes(searchQuery.toLowerCase())) {
      return false;
    }
                    ...
                    filteredRides.map((ride) => (
                      <TableRow key={ride.id}>
                        ...
                        <TableCell className="text-right">
                          <Badge className={cn("font-normal", getStatusColor(ride.status))}>
                            {ride.status}
                          </Badge>
                        </TableCell>
                      </TableRow>
                    ...
                    <TableRow>
                      <TableCell colSpan={3} className="h-24 text-center">
                        <div className="flex flex-col items-center justify-center py-8">
                          ...
                          <p className="text-lg font-medium mb-1">No ride history</p>
                          <p className="text-muted-foreground text-sm mb-4">You haven't taken any rides yet</p>
