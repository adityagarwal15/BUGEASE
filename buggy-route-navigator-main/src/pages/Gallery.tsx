...
import { Grid3X3, Grid2X2, Image, PlayCircle, X, ChevronLeft, ChevronRight, Info } from 'lucide-react';
...
const galleryVideos = [
  {
    id: 1,
    thumbnail: "https://images.unsplash.com/photo-1579261456554-f8091a9aca7a?q=80&w=1470&auto=format&fit=crop",
  ...
  {
    id: 2,
    thumbnail: "https://images.unsplash.com/photo-1567609313456-8c105a69e75d?q=80&w=1470&auto=format&fit=crop",
  ...
  {
    id: 3,
    thumbnail: "https://images.unsplash.com/photo-1593765921772-de7cf35eaf29?q=80&w=1405&auto=format&fit=crop",
  ...
  {
    id: 4,
    thumbnail: "https://images.unsplash.com/photo-1593698054009-35b887fee95f?q=80&w=1470&auto=format&fit=crop",
...
const Gallery = () => {
  ...
  const [filter, setFilter] = useState<'all' | 'vehicles' | 'people' | 'stations' | 'campus'>('all');
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-muted-foreground">Explore photos and videos of our campus transportation system</p>
      </div>
      ...
      <Tabs defaultValue="photos" className="w-full">
        ...
        <TabsContent value="photos" className="mt-0">
          <div className={`grid ${gridView === 'grid3x3' ? 'grid-cols-2 md:grid-cols-3 lg:grid-cols-4' : 'grid-cols-1 md:grid-cols-2'} gap-4`}>
              ...
              >
                <CardContent className="p-0 relative">
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-muted-foreground mt-1 capitalize">{video.category}</p>
                  </div>
                </CardContent>
              </Card>
            ))}
        ...
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center">
          <div className="absolute top-4 right-4 flex gap-2">
            <Button
              ...
              onClick={() => {
                const currentIndex = filteredImages.findIndex(img => img.id === selectedImage.id);
                alert(`Image ${currentIndex + 1} of ${filteredImages.length}: ${selectedImage.description}`);
              }}
            >
