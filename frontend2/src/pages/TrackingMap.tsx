...
import { mockPendingRide } from '@/data/buggies'; // Keep mock ride for now
...
const CAMPUS_CENTER = { lat: 40.7128, lng: -74.006 }; // Example: NYC coordinates
...
const TrackingMap = () => {
  ...
  const { locations: wsLocations, isConnected } = useWebSocketLocations();
